function Applications(props) {
  return (
    <section className="sectionContainer flex w-full flex-col items-center justify-center bg-primary-dark">
      ...
      <div className="applications-wrapper grid w-8/12 grid-cols-1 justify-center gap-20 py-12 lg:flex lg:w-10/12 2xl:w-8/12">
        <div className="app flex w-full flex-col overflow-hidden rounded-xl border border-primary-darker bg-primary-darker/80">
          ...
          <div className="appInfo flex flex-col p-4">
            ...
            <p className="appDescription indent-8 text-base text-white sm:text-xl lg:text-lg xl:text-xl">
            ...
            <a
              className="appLinks relative py-3 text-base text-white hover:font-bold sm:text-xl lg:text-lg xl:text-xl"
              rel="noreferrer"
              target="_blank"
